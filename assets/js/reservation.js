$.getScript(root + 'assets/js/smartwizard.js')
var rooms = []
var quantity = 0
      ...
      if (stepNumber == 0) {
        ...
        if (quantity > MAX_ROOM_ALLOWED) {
          swal({
            ...
            html: MAX_ROOM_ERROR.replace('{0}', MAX_ROOM_ALLOWED) + '<br/><small>(075) 636-0910 / (075) 205-0647 0929-789-0088 / 0995-408-6292</small>',
            type: 'warning'
          })
          return false
        }
