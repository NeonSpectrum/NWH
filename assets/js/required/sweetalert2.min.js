! function(e, t) {
  ...
  var e = {
    ...
    p = function(e) {
      ...
      t && (t.parentNode.removeChild(t), q(document.body, o["no-backdrop"]), q(document.body, o["has-input"]), q(document.body, o["toast-shown"])); {
        if (a(document)) {
          ...
          n.className = o.container, n.innerHTML = f;
          ...
          return i.oninput = g, s.onchange = g, d.onchange = g, p.onchange = g, h.oninput = g, u.oninput = function() {
            g(), c.value = u.value
          }, u.onchange = function() {
            g(), u.previousSibling.value = u.value
          }, r
        }
    ...
    V = function(e, t) {
      t || (t = e === b() || e === S() ? "flex" : "block"), e.style.opacity = "", e.style.display = t
    },
    N = function(e) {
    ...
    M = function() {
      ...
      for (var n in t)
        if (t.hasOwnProperty(n) && a(e.style[n])) return t[n];
      return !1
    }(),
  ...
  var z = function(e) {
      for (var t in e) Y.isValidParameter(t) || s('Unknown parameter "' + t + '"'), Y.isDeprecatedParameter(t) && c('The parameter "' + t + '" is deprecated and will be removed in the next major release.')
    },
    K = function(t) {
      ...
      t.showCloseButton ? (O.setAttribute("aria-label", t.closeButtonAriaLabel), V(O)) : N(O), n.className = o.popup, t.toast ? (T(document.body, o["toast-shown"]), T(n, o.toast)) : T(n, o.modal), t.customClass && T(n, t.customClass);
      var R = w(),
      ...
      t.progressSteps.length ? (V(R), function(e) {
        ...
        if (T(r, o.progresscircle), r.innerHTML = e, n === I && T(r, o.activeprogressstep), R.appendChild(r), n !== t.progressSteps.length - 1) {
          ...
          T(i, o.progressline), i.style.width = t.progressStepsDistance, R.appendChild(i)
        }
      })) : N(R);
    ...
    Q = function() {
      if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !E(document.body, o.iosfix)) {
        ...
        document.body.style.top = -1 * e + "px", T(document.body, o.iosfix)
      }
    },
    Y = function e() {
      for (var t = arguments.length, n = Array(t), r = 0; r < t; r++) n[r] = arguments[r];
      if (a(window)) {
        if (!a(n[0])) return l("SweetAlert2 expects at least 1 attribute!"), !1;
        var s = R({}, I);
        switch (H(n[0])) {
          case "string":
          ...
          case "object":
            ...
            break;
          default:
            return l('Unexpected type of argument! Expected "string" or "object", got ' + H(n[0])), !1
        }
        K(s);
        var p = m(),
          f = b();
        return new Promise(function(t, n) {
          var r = function(n) {
              e.closePopup(s.onClose), t(s.useRejections ? n : {
                value: n
              })
            },
            a = function(o) {
              e.closePopup(s.onClose), s.useRejections ? n(o) : t({
                dismiss: o
              })
            },
            u = function(t) {
              e.closePopup(s.onClose), n(t)
            };
          ...
          for (var h = function(t) {
                    ...
                    if (e.disableButtons(), s.input) {
                      ...
                      if (s.inputValidator) {
                        ...
                        s.expectRejections ? m.then(function() {
                          e.enableButtons(), e.enableInput(), h(f)
                        }, function(t) {
                          e.enableButtons(), e.enableInput(), t && e.showValidationError(t)
                        }) : m.then(function(t) {
                          e.enableButtons(), e.enableInput(), t ? e.showValidationError(t) : h(f)
                        }, function(e) {
                          return u(e)
                        })
                      } else h(f)
            ...
            }, I = f.querySelectorAll("button"), D = 0; D < I.length; D++) I[D].onclick = R, I[D].onmouseover = R, I[D].onmouseout = R, I[D].onmousedown = R;
          A().onclick = function() {
            a("close")
          ...
          W || (U = window.onkeydown, W = !0, window.onkeydown = function(t) {
            ...
            if ("Enter" !== n.key || n.isComposing)
              if ("Tab" === n.key) {
                for (var o = n.target || n.srcElement, r = B(s.focusCancel), i = -1, l = 0; l < r.length; l++)
                  if (o === r[l]) {
                    i = l;
                    break
                  }
          ...
          }), s.buttonsStyling && (Y.style.borderLeftColor = s.confirmButtonColor, Y.style.borderRightColor = s.confirmButtonColor), e.hideLoading = e.disableLoading = function() {
            s.showConfirmButton || (N(Y), s.showCancelButton || N(S())), q(z, o.loading), q(f, o.loading), f.removeAttribute("aria-busy"), Y.disabled = !1, _.disabled = !1
          }, e.getTitle = function() {
            return g()
            ...
            s.progressSteps = e, K(s)
          }, e.showProgressSteps = function() {
            V(w())
          }, e.hideProgressSteps = function() {
            N(w())
          }, e.enableButtons(), e.hideLoading(), e.resetValidationError(), s.input && T(document.body, o["has-input"]);
          for (var J = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], X = void 0, F = 0; F < J.length; F++) {
            ...
            ee.className = G, s.inputClass && T(ee, s.inputClass), N(ee)
          }
          var re = void 0;
          switch (s.input) {
            case "text":
            ...
            case "tel":
            case "url":
              (X = O(f, o.input)).value = s.inputValue, X.placeholder = s.inputPlaceholder, X.type = s.input, V(X);
              break;
            case "file":
              (X = O(f, o.file)).placeholder = s.inputPlaceholder, X.type = s.input, V(X);
              break;
            case "range":
              var ie = O(f, o.range),
                ae = ie.querySelector("input"),
                se = ie.querySelector("output");
              ae.value = s.inputValue, ae.type = s.input, se.value = s.inputValue, V(ie);
              break;
            case "select":
              var le = O(f, o.select);
              if (le.innerHTML = "", s.inputPlaceholder) {
                var ue = document.createElement("option");
                ue.innerHTML = s.inputPlaceholder, ue.value = "", ue.disabled = !0, ue.selected = !0, le.appendChild(ue)
              }
              re = function(e) {
                for (var t in e) {
                  var n = document.createElement("option");
                  n.value = t, n.innerHTML = e[t], s.inputValue.toString() === t && (n.selected = !0), le.appendChild(n)
                }
                V(le), le.focus()
              };
              break;
            case "radio":
              ...
              ce.innerHTML = "", re = function(e) {
                for (var t in e) {
                  ...
                  n.type = "radio", n.name = o.radio, n.value = t, s.inputValue.toString() === t && (n.checked = !0), i.innerHTML = e[t], r.appendChild(n), r.appendChild(i), r.for = n.id, ce.appendChild(r)
                }
                V(ce);
            ...
            case "checkbox":
              var de = O(f, o.checkbox),
                pe = c("checkbox");
              pe.type = "checkbox", pe.value = 1, pe.id = o.checkbox, pe.checked = Boolean(s.inputValue);
              var fe = de.getElementsByTagName("span");
              fe.length && de.removeChild(fe[0]), (fe = document.createElement("span")).innerHTML = s.inputPlaceholder, de.appendChild(fe), V(de);
              break;
            case "textarea":
              var me = O(f, o.textarea);
              me.value = s.inputValue, me.placeholder = s.inputPlaceholder, V(me);
              break;
            case null:
              break;
            default:
          ...
          "select" !== s.input && "radio" !== s.input || (s.inputOptions instanceof Promise ? (e.showLoading(), s.inputOptions.then(function(t) {
            ...
            function(e, t, n) {
              var r = m(),
                i = b();
              null !== t && "function" == typeof t && t(i), e ? (T(i, o.show), T(r, o.fade), q(i, o.hide)) : q(i, o.fade), V(i), r.style.overflowY = "hidden", M && !E(i, o.noanimation) ? i.addEventListener(M, function e() {
                i.removeEventListener(M, e), r.style.overflowY = "auto"
              }) : r.style.overflowY = "auto", T(document.documentElement, o.shown), T(document.body, o.shown), T(r, o.shown), P() && (Z(), Q()), d.previousActiveElement = document.activeElement, null !== n && "function" == typeof n && setTimeout(function() {
                n(i)
              })
            }(s.animation, s.onBeforeOpen, s.onOpen), s.toast || (s.allowEnterKey ? s.focusCancel && j(_) ? _.focus() : s.focusConfirm && j(Y) ? Y.focus() : $(-1, 1) : document.activeElement && document.activeElement.blur()), m().scrollTop = 0
        })
      }
    };
  return Y.isVisible = function() {
    ...
    var t = S(),
      n = x(),
      r = k();
    V(t), V(n, "inline-block"), T(t, o.loading), T(e, o.loading), n.disabled = !0, r.disabled = !0, e.setAttribute("aria-busy", !0), e.focus()
  ...
  }, Y.noop = function() {}, Y.version = "7.0.6", Y.default = Y, Y
