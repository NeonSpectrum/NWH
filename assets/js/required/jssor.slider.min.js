      ...
      a.xe = function(c, b) {
        ...
        if (!a.jc[f]) {
          ...
          for (var d = 0; d < a.$Cols; d++)
            for (var e = 0; e < a.$Rows; e++) a.jc[f][e + "," + d] = {
              $Top: e * b,
              $Right: d * c + c,
              $Bottom: e * b + b,
              $Left: d * c
