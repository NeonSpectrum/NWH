  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
    <ul class="nav sidebar-nav">
      ...
      <li <?php echo $overview;?>>
        <a href="<?php echo $overview=='' ? '/admin' : 'javascript:void(0)';?>">Overview</a>
      </li>
      <li <?php echo $accounts;?>>
        <a href="<?php echo $accounts=='' ? '/admin/accounts' : 'javascript:void(0)';?>">Accounts</a>
      </li>
      <li <?php echo $roommanagement;?>>
        <a href="<?php echo $roommanagement=='' ? '/admin/roommanagement' : 'javascript:void(0)';?>">Room Management</a>
      </li>
      <li <?php echo $reservation;?>>
        <a href="<?php echo $reservation=='' ? '/admin/reservation' : 'javascript:void(0)';?>">Reservation</a>
      </li>
      ...
      <li>
        <a href="/login/checkLogout.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a>
      </li>
    </ul>
  </nav>
