...
<header class="l-header">
  <div class="l-header__inner clearfix" style="user-select:none">
    ...
    <a id="btnGitUpdate" style="cursor:pointer;text-decoration:none" class="c-header-icon"><i class="fa fa-cloud-download"></i></a>
    <a href="<?php echo $root;?>account/logout.php" style="text-decoration:none" class="c-header-icon"><i class="fa fa-power-off"></i></a>
  </div>
</header>
<div class="l-sidebar">
      ...
      <ul class="u-list">
        ...
        <li class="c-menu__item has-submenu <?php echo $settings;?>" title="Settings">
          ...
          <ul class="c-menu__submenu u-list">
            ...
            <li>
              <a class="c-menu__item__inner" href="<?php echo $root;?>admin/settings/rooms"><i class="fa fa-home"></i>
