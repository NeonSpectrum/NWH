...
if ($_SERVER['REQUEST_METHOD'] == "POST" && $system->validateToken($_POST['csrf_token'])) {
  ...
  $html .= "<td style='text-align:right;font-size:16px;width:20%;padding-left:20px'>" . count($room->getDatesFromRange($row['CheckIn'], $row['CheckOut'])) . "</td>";
  $html .= "</tr>";
  $html .= "<tr>";
  $html .= "<td style='text-align:right;font-size:16px;font-weight:bold'>Extra Charges:</td>";
  $html .= "<td style='text-align:right;font-size:16px;width:20%;padding-left:20px'>₱&nbsp;" . number_format($row['ExtraCharges'], 2, '.', ',') . "</td>";
  $html .= "</tr>";
  $html .= "<tr>";
  $html .= "<tr>";
  $html .= "<td style='text-align:right;font-size:16px;font-weight:bold'>Discount:</td>";
  $html .= "<td style='text-align:right;font-size:16px;width:20%;padding-left:20px'>" . (strpos($row['Discount'], "%") !== false ? $row['Discount'] : "₱&nbsp;" . number_format($row['Discount'], 2, '.', ',')) . "</td>";
  $html .= "</tr>";
  $html .= "<tr>";
  ...
  $html .= "</tr>";
  $html .= "<tr>";
  $html .= "<td style='text-align:right;font-size:16px;font-weight:bold'>VAT:</td>";
