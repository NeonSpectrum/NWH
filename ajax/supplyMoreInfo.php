...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $arr[1] = "{$row['RoomDescription']}<br/><div style='padding:20px;text-align:center;font-size:30px;font-style:bold'>Price: ₱&nbsp;" . number_format($room->getRoomPrice($row['RoomType'])) . "</div>";
