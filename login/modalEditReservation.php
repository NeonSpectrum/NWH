          ...
          <div id="lblDisplayErrorEditReservation">
            <!-- error will be shown here ! -->
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input name="txtEditCheckInDate" type="date" class="form-control" id="txtEditCheckInDate" onkeydown="return disableNumber(event)" required/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Check Out Date</label>
						<div class="col-sm-7">
							<input name="txtEditCheckOutDate" type="date" class="form-control" id="txtEditCheckOutDate" onkeydown="return disableNumber(event)" required/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Adults</label>
						<div class="col-sm-3">
							<input name="txtEditAdults" type="number" class="form-control" id="txtEditAdults" placeholder="Adults" onkeypress="return disableLetter(event)" min="0" max="10" value="0" required/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Childrens</label>
						<div class="col-sm-3">
							<input name="txtEditChildrens" type="number" class="form-control" id="txtEditChildrens" placeholder="Childrens" onkeypress="return disableLetter(event)" min="0" max="10" value="0" required/>
						</div>
					</div>
