...
<head>
	...
	<link rel="apple-touch-icon" type="image/png" href="../images/logo-57.png">
	<link rel="apple-touch-icon" type="image/png" sizes="72x72" href="../images/logo-72.png">
	<link rel="apple-touch-icon" type="image/png" sizes="114x114" href="../images/logo-114.png">
	<link rel="icon" type="image/png" href="../images/logo-114.png">
...
<div class="fm-container">
	...
	<div class="fm-wrapper">
		...
		<script type="text/javascript" src="scripts/cldrjs/cldr.js"></script>
		<script type="text/javascript" src="scripts/cldrjs/cldr/event.js"></script>
		<script type="text/javascript" src="scripts/cldrjs/cldr/supplemental.js"></script>
		<script type="text/javascript" src="scripts/globalizejs/globalize.js"></script>
		<script type="text/javascript" src="scripts/globalizejs/globalize/number.js"></script>
		<script type="text/javascript" src="scripts/globalizejs/globalize/date.js"></script>
