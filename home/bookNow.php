<div class="booknow center-block">
	<div class="booknow-content">
		...
		<label style="margin-left:20px;">Check In Date: </label>
			<input type="date" id="txtBookCheckInDate" name="txtBookCheckInDate" onkeypress="return disableNumber(event)" required/>
			<label style="margin-left:20px;">Check Out Date: </label>
			<input type="date" id="txtBookCheckOutDate" name="txtBookCheckOutDate" onkeypress="return disableNumber(event)" required/>
