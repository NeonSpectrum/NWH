  ...
  <div class="booknow-content text-center">
    <form id="frmBookNow" class="form-inline">
        <div class="form-group">
          ...
          <input class="form-control checkInDate" type="date" id="txtBookCheckInDate" name="txtBookCheckInDate" onkeypress="return disableKey(event,'number')" required/>
        </div>
        <div class="form-group">
          <label>Check Out Date: </label>
          <input class="form-control checkOutDate" type="date" id="txtBookCheckOutDate" name="txtBookCheckOutDate" onkeypress="return disableKey(event,'number')" required/>
        </div>
        <div class="form-group">
          <label>Adults: </label>
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="number" id="txtBookChildren" name="txtBookChildren" value="0" onkeypress="return disableKey(event,'letter')" min="0" max="10" required/>
        </div>
        <div class="form-group">
          <label></label>
